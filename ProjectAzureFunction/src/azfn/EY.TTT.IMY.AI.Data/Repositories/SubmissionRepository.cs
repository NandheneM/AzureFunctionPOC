...
namespace EY.TTT.IMY.AI.Data.Repositories
{
    public class SubmissionRepository : ISubmissionRepository
    {
        ...
        public SubmissionRepository(IDBHelper dbHelper, ILogger<SubmissionRepository> logger)
        {
            _dbHelper = dbHelper;
            _logger = logger;
        }

        public async Task InsertSubmissionAsync(string submissionId, string caseNumber, string investorId, string filePath)
        {
            const string sql = @"
        ...
        public async Task<string> GenerateSubmissionIdAsync()
        {
            try
            {
